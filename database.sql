...
-- 默认管理员密码通过 site_config 表管理
INSERT INTO site_config (key, value)
VALUES ('admin_password_hash', encode(sha256(('congshaoyu102@' || 'sucaiku_v2_salt')::bytea), 'hex'))
ON CONFLICT (key) DO UPDATE SET value = encode(sha256(('congshaoyu102@' || 'sucaiku_v2_salt')::bytea), 'hex');
